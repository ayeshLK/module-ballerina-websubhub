...
service /subscriber  on new websub:Listener(9100) {
    remote function onEventNotification(websub:ContentDistributionMessage event) returns websub:Acknowledgement|error {
